...
class Constants
{
    ...
    */
    ...
    public const CustomerQueryControlNumberDetails = '1026';
    ...
    */
    ...
    public const FAILED_VALIDATING_IMEI = 'Invalid Credentials';
    public const OPERATOR_INACTIVE_SUSPENDED = 'Account Locked';// OPERATOR/AGENT IS INACTIVE/SUSPENDED
    public const OPERATOR_NOT_EXIST = 'Invalid Credentials';
    public const AGENT_NOT_EXIST = 'Invalid Credentials';
    ...
    public const NO_MATCHING_RECORDS = 'Invalid Credentials';
    public const DECRYPTION_FAILED = 'Bad Request';
