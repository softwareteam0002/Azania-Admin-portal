...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ url('esb/parishes/update',[$institution->id]) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="row">
                   <div class="col-md-6">
                    ...
                    <div class="col-md-12">
                        ...
                        <a href="{{ url('esb/parishes/index') }}" class="btn btn-sm btn-link"><i class="fas fa-arrow-left"></i> Go back</a>
                    </div>
                </div>
            </form>
        </div>
