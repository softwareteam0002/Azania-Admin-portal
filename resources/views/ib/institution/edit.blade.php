...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <h6 class="mb-3"> Edit institution form</h6>
            <p class="small text-danger">All fields with an asterisk(*) are mandatory.</p>
            <form action="{{ url('ib/institutions/update',[$institution->id]) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" id="address" name="address" value="{{ $institution->address }}" class="form-control form-control-sm" >
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <textarea  class="form-control form-control-sm" name="description" id="description" cols="10" rows="1">{{ $institution->description }}</textarea>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                    ...
                    <div class="col-md-12">
                        ...
                        <a href="{{ url('ib/institutions/index') }}" class="btn btn-sm btn-link"><i class="fas fa-arrow-left"></i> Go back</a>
                    </div>
                </div>
            </form>
        </div>
