...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb small" style="background-color:#f9f9f9; padding: .55rem 1rem;">
            ...
            <li class="breadcrumb-item active">Letter of credit requests</li>
        </ol>
    </nav>


    <h5>Letter of credit requests</h5>
    <hr/>

    <div class="card">
        <div class="card-body">
            <h6 class="mb-4">All Letter of credit requests</h6>
                ...
                <table class="table table-responsive-sm table-striped table-sm table-hover datatable">
                    ...
                    @foreach($requests as $request)
                        <tr data-entry-id="1" data-toggle="modal" data-target="#largeModal{{$request->id}}" id="loadingModel" data="{{$request->id}}">
                            ...
                            <td class='text-right font-weight-bold'>{{number_format($request->amount,2) ?? '0'}}</td>
                            ...
                            <td>
                                <form action="{{ url('ib/requests/actions') }}" method="POST">
                                    ...
                                    <input type="hidden" name="request_type" value="letter_credit_request">
