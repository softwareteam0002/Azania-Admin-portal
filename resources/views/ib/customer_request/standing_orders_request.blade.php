...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb small" style="background-color:#f9f9f9; padding: .55rem 1rem;">
            ...
            <li class="breadcrumb-item active">Standing Order requests</li>
        </ol>
    </nav>


    <h5>Standing Order requests details</h5>
    <hr/>


    <div class="card">
        <div class="card-body">
            <h6 class="mb-3">All standing order requests</h6>
            <div class="table-responsive">
                <table class="table table-responsive-sm table-striped table-sm table-hover datatable">
                    ...
                    @foreach($standing_orders as $request)
                        <tr data-entry-id="{{$request->id}}" data-toggle="modal" data-target="#largeModal{{ $request->id }}">
                            ...
                            <td>
                                ...
                                @endif
								 @if($request->status_id == 10)
                                    ...
                                    <h5><span class="badge badge-danger">Blocked</span></h5>
                            ...
                            <td>
                                ...
                                <form action="{{ url('ib/requests/actions') }}" method="POST">
                                    ...
                                    <input type="hidden" name="request_type" value="standing_order_request">
                                    
									@if($request->status_id != 10)
                                    <button type="submit" name="status"  title="Block"  class="btn btn-danger btn-sm"><span><i class="fas fa-ban text-dark-pastel-green"></i></span></button>
									@endif
