...
@section('content')
    ...
    <div class="card mb-5">
        <div class="card-body">
            <h6>Disable Bank form</h6>
            <p class="small text-danger">All fields with an asterisk(*) are mandatory.</p>
            <form action="{{ route('ib.bank.disableAct', $bank->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control form-control-sm" value="{{ $bank->name ?? '' }}" placeholder="Enter bank name here." readonly>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <textarea name="description" class="form-control form-control-sm" id="" cols="30"  rows="4" placeholder="Enter descriton here." readonly>{{ $bank->description ?? '' }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <textarea name="address" class="form-control form-control-sm" id="" cols="30" rows="4" placeholder="Enter address here." readonly>{{ $bank->address ?? '' }}</textarea>
                        </div>
                    </div>
