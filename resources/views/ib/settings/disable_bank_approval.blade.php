...
@section('content')
    ...
    <div class="card mb-5">
        <div class="card-body">
            <h6>@if($bank->status == 'Disabled') Enable @endif
                @if($bank->status == 'Active') Disable @endif Bank Approval form</h6>
                ...
                <div class="row">
                    ...
                    <input type="hidden" name="approver_id" value="0">
                     ...
                     <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control form-control-sm" placeholder="Enter bank name here." value="{{ $bank->name }}" readonly>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <textarea name="description" class="form-control form-control-sm" id="" cols="30" rows="4" placeholder="Enter description here." readonly>{{ $bank->description }}</textarea>
                        </div>
                    </div>
