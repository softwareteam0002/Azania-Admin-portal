...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb small" style="background-color:#f9f9f9; padding: .55rem 1rem;">
            ...
            <li class="breadcrumb-item"><a href="{{ route('ib.view_branch') }}">Branch details</a></li>
                ...
                <div class="col-md-6">
                    <table class="table table-sm">
                        <tbody>
                            ...
                            <tr><td  class="font-weight-bold">Disable Status:</td>
                                <td> @if($branch->status == 'Disabled')
                    ...
                    <hr/>
                    <a href="{{ route('ib.view_branch') }}" class="btn btn-sm btn-link">Go back</a>
                </div>
            </div>
        </div>
    </div>
