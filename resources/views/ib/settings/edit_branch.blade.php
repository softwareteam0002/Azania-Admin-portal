...
@section('content')
    ...
    <div class="card mb-5">
        <div class="card-body">
            ...
            <form action="{{ url('ib/update_branch') }}" method="POST">
                @csrf
                @method('PUT')
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="branchName" class="form-control form-control-sm" value="{{ $branch->branchName ?? '' }}" placeholder="Enter bank name here.">
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="branch_code" class="form-control form-control-sm" value="{{ $branch->branch_code ?? '' }}" placeholder="Enter branch code here.">
                        </div>
                    </div>
                     <div class="col-md-3">
                        <div class="form-group">
                            <label for="name">BIC/Swift Code:</label>
                            <input type="text" name="swift_code" class="form-control form-control-sm" value="{{ $branch->swift_code ?? '' }}"placeholder="Enter BIC/Swift Code here.">
                        </div>
                    </div>
                     <div class="col-md-3">
                            <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <textarea name="description" class="form-control form-control-sm" id="" cols="30"  rows="4" placeholder="Enter descriton here.">{{ $branch->description ?? '' }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <textarea name="address" class="form-control form-control-sm" id="" cols="30" rows="4" placeholder="Enter address here.">{{ $branch->address ?? '' }}</textarea>
                        </div>
                    </div>
