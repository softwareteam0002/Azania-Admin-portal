...
@section('content')
    ...
    <div class="card mb-5">
        <div class="card-body">
            <h6>Disable Branch form</h6>
            <p class="small text-danger">All fields with an asterisk(*) are mandatory.</p>
            <form action="{{ route('ib.branch.disableAct', $branch->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="row">

                    <input type="hidden" name="action" value="Disable Branch">
                    ...
                    <div class="col-md-12">
                       ...
                       <!-- <input title="Reject" type="submit" name="performed_act2" value="reject" class="btn btn-warning btn-sm" value="Reject" />-->
