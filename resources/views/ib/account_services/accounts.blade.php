            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="agency_commision_account" class="form-control form-control-sm" placeholder="Enter agency commision account here.">
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="agency_expenses_deposit" class="form-control form-control-sm" placeholder="Enter agency expense deposit here.">
                    </div>
                </div>
