...
<div class="card">
        ...
        <div class="row">
            <div class="col-md-10">
                ...
                <div class="input-group">
                    <select class="custom-select" id="serviceBatchID" aria-label="Example select with button addon">
                        ...
                        <option value="{{ $batch->batch_id }}" selected>Batch #: {{ $batch->batch_id }} From: {{ $batch->from_date }} - [
                        ...
                        @else
                        <option value="{{ $batch->batch_id }}">Batch #: {{ $batch->batch_id }} From: {{ $batch->from_date }} - [
                            @if($batch->batch_status == 1)
                            Active
                            @else
                            Inactive
            ...
            <div class="col-md-2">
                <div class=''>
                    ...
                    <form action="{{ url('ib/servicecharges/batch') }}" method="POST" class="d-inline">
                        @csrf
    ...
    <script>
        function attrClick() {
            ...
            window.location.replace("{{ url('ib/servicecharges/') }}/" + v);;
        }
    </script>
</div>
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-md-4 text-center">
			 ...
			 <button type="button" class="btn btn-success btn-sm" title="Upload" data-toggle="modal" data-target="#chargesUploadModal">
        ...
        <div class="row">
             ...
             @endif
             @if (session()->has('charge_message'))
                 <div class="alert alert-success">
                         {{ session()->get('charge_message') }}
                 </div>   
             @endif
             <!-- <form action="{{ route('ib.service_charges.import') }}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
                    ...
                    <div class="tab-pane fade show active" id="fixedcharges" role="tabpanel" aria-labelledby="pills-home-tab">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ url('ib/charges') }}" method="POST">
                                    @csrf
                                    @method('POST')
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="charge_amount" id="charge_amount" placeholder="Enter the charge amount" class="form-control form-control-sm number">
                                                <input type="hidden" name="batch_id" value="{{ $activebatch->batch_id }}">
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <table class="table table-striped table-sm table-hover datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if( $activebatch->batch_status == 2)
                                        <form action="{{ url('ib/servicecharges/delete') }}" method="POST" class="d-inline">
                                            @csrf
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ url('ib/servicecharges/delete') }}" method="POST" class="d-inline">
                                            @csrf
                                            <input type="hidden" name="charge_id" value="{{ $charge->charge_id }}">
                                            <a  class="btn btn-danger btn-sm" title="Delete" href="{{ url('tracker') }}">
                                                <i class="fas fa-trash"></i>
                                            </a>
                                        </form>
                                        @endif
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="from_amount" id="from_amount" placeholder="Enter begining range amount" class="form-control form-control-sm number">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="to_amount" id="to_amount" placeholder="Enter ending range amount" class="form-control form-control-sm number">
                                            </div>
                                        </div>
...
<div class="modal fade" id="chargesUploadModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
      <h4 class="modal-title" id="myModalLabel">Upload Service Charges</h4>
