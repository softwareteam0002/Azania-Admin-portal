...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        @if(session()->has('responseCode'))
                            <input type="text" id="account_number" name="account_number"
                                   value="{{session()->get('accountID')}}" class="form-control form-control-sm"
                                   required>
                        @else
                            <input type="text" id="account_number" name="account_number"
            ...
            <form action="{{ url('agency/user/store') }}" method="POST" class="pt-2">
                @csrf
                @method('POST')
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                            ...
                            @if(session()->has('responseCode'))
                                <input type="text" id="name" name="name" class="form-control form-control-sm"
                                       value="{{ old('name', session()->has('clientName') ? session()->get('clientName') : '') }}"
                                       placeholder="Enter the full name here." readonly/>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            @if(session()->has('responseCode'))
                                <input type="text" id="phone" name="mobile_number" minlength="10" maxlength="12"
                                       class="form-control form-control-sm"
                                       value="{{ old('phone', session()->has('phone') ? session()->get('phone') : '') }}"
                                       placeholder="Enter mobile number here." readonly="">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="tin_number" class="form-control form-control-sm"
                                   placeholder="Enter the TIN number." required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="business_licence" class="form-control form-control-sm"
                                   placeholder="Enter the business licence." required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="float_limit" class="form-control form-control-sm"
                                   placeholder="Enter the maximum float limit." required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="daily_limit" class="form-control form-control-sm"
                                   placeholder="Enter the daily limit." required>
                        </div>
                    </div>
                    ...
                    @if(session()->has('responseCode'))
                        <input type="hidden" id="clientId" name="clientId" class="form-control form-control-sm"
                               value="{{ old('clientId', session()->has('clientId') ? session()->get('clientId') : '') }}"
                               readonly="">
                        ...
                        <div class="form-group">
                            ...
                            @if(session()->has('responseCode'))
                                <input type="text" name="branchName" class="form-control form-control-sm"
                                       value="{{ session()->get('branchName') }}" placeholder="Enter Branch Name."
                                       required>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="famous_name" class="form-control form-control-sm"
                                   placeholder="Enter area famous name." required>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{url('agency/users')}}" method="GET">
                <div class="row">
                    <div class="col-4 form-group">
                        <label for="account">Agent Number:</label>
                        <input type="text" name="agent_number" class="form-control" placeholder="Enter agents number">
                    </div>
                    <div class="col-4 form-group">
                        <label for="account">Name:</label>
                        <input type="text" name="name" class="form-control" placeholder="Enter agents name">
                    </div>
                    <div class="col-4 form-group">
                        <label for="account">Mobile Number:</label>
                        <input type="text" name="mobile_number" class="form-control"
                               placeholder="Enter agents mobile number">
                    </div>
                </div>
                <hr>
                <div class="row">
                    <div class="col-12 form-group mg-t-8">
                        ...
                        <a href="{{url('agency/users')}}" class="btn btn-danger">Clear Filter <i class="fa
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @if(Auth::user()->id != $agent->initiator_id && $agent->isWaitingApproval==1)
                                    <a href="{{ route('agency.agent.approve', $agent->agent_id) }}" type="submit"
                                       name="submit_value" value="approve" class="btn btn-success btn-sm">
                                        <span><i class="fas fa-check text-dark-pastel-green"></i></span>
                                        @endif
                                        <a href="{{ url('agency/accounts', [$agent->agent_id]) }}" title="Accounts"
                                           class="btn btn-sm btn-primary">
                                            <span><i class="fas fa-money-check-alt"></i></span>
                                        </a>
                                        @if(Auth::user()->action_id == 1 || Auth::user()->action_id == 3)
                                            <a href="{{ url('agency/user/edit',[$agent->agent_id]) }}"
                                               title="Edit agent" class="btn btn-sm btn-primary">
                                                <span><i class="fas fa-edit text-dark-pastel-green"></i></span>
                                            </a>
                                        @endif
                                        <a href="{{ url('agency/devices', [$agent->agent_id]) }}" title="Devices"
                                           class="btn btn-sm btn-primary">
                                            <span><i class="fas fa-mobile-alt"></i></span>
                                        </a>
                                        <a href="{{ url('agency/operators', [$agent->agent_id]) }}" title="Operators"
                                           class="btn btn-sm btn-primary">
    ...
    @section('scripts')
        ...
        <script>
            ...
            $('#regions').change(function () {
                ...
                $.ajax({
                    url: "https://uat.ubx.co.tz:8888/mhbportal/api/agency/districts/" + region_id,
                    method: "GET",
