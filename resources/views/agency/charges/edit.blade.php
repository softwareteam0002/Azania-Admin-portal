...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb small" style="background-color:#f9f9f9; padding: .55rem 1rem;">
            ...
            <li class="breadcrumb-item"><a href="{{ url('agency/charges') }}">Service charges</a></li>
    ...
    <div class="card mb-5">
        <div class="card-body">
            ...
            <form action="{{ url('agency/charges',[$service->charge_id]) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="col-md-12">
                    ...
                    <a href="{{ url('agency/charges') }}" class="btn btn-link btn-sm">Go back</a>
                </div>
