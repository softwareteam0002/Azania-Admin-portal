                ...
                <tbody>
                    ...
                    <tr data-entry-id="{{ $userManagement->id }}">
                        ...
                        <td>
                            ...
                            <a class="btn btn-sm btn-primary" href="{{ route('admin.user-managements.show', $userManagement->id) }}">
                            <i class="fas fa-eye"></i>
                            </a>
                            @endcan
                            @can('user_management_edit')
                            <a class="btn btn-sm btn-info" href="{{ route('admin.user-managements.edit', $userManagement->id) }}">
