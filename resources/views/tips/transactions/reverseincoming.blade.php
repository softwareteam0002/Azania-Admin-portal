...
<div class="mt-12">
        <div class="row">
          <div class="col-12 col-sm-10 col-md-12">
            ...
            'method' => 'PATCH',
            'url' => ['tips/transactions/reverseincoming', $transaction->id],
            'role' => 'form'
        ]) !!}
                  <div class="row">
				 ...
				 <div class="row">
				  ...
				  <div class="row">
                    <div class="form-group col-6">
                      {!! Form::label('payer_identifier', 'PAYER IDENTIFIER', array('class' => 'd-block')) !!}
                    {!! Form::text('payer_identifier',null,['class'=>'form-control', 'placeholder'=>'Payer Identifier', 'required' => 'required', 'readonly']) !!}
                    </div>
                    <div class="form-group col-6">
                      {!! Form::label('payee_identifier', 'PAYEE IDENTIFIER', array('class' => 'd-block')) !!}
                    {!! Form::text('payee_identifier',null,['class'=>'form-control', 'placeholder'=>'Payee Identifier', 'readonly']) !!}
                    </div>
                  </div>
				  <div class="row">
				  <div class="form-group col-6">
                      {!! Form::label('payee_fullName', 'PAYEE NAME', array('class' => 'd-block')) !!}
                    {!! Form::text('payee_fullName',null,['class'=>'form-control', 'placeholder'=>'Payee Name', 'readonly']) !!}
                    </div>
					<div class="form-group col-6">
                      {!! Form::label('description', 'DESCRIPTION', array('class' => 'd-block')) !!}
                    {!! Form::text('description',null,['class'=>'form-control', 'placeholder'=>'Description', 'readonly']) !!}
                    </div>
				  </div>
				  <div class="row">
                    <div class="form-group col-6">
				  ...
				  <div class="form-group">
                    ...
                    {!! Form::textarea('reversalReason',null,['class'=>'form-control', 'placeholder'=>'Reversal Reason', 'rows'=>1]) !!}
                  </div>
				  <div class="row">
                  <div class="form-group col-6">
				  <button type='submit' class='btn btn-primary btn-block' value='commit' name='commit' >Commit Reversal</button>
                     <!--{!! Form::submit('Commit Reversal', ['class'=>'btn btn-primary btn-block']) !!}-->
                  </div>
				  <div class="form-group col-6">
				  <button type='submit' class='btn btn-danger btn-block' value='reject' name='reject' >Reject Reversal</button>
					 <!--{!! Form::submit('Reject Reversal', ['class'=>'btn btn-danger btn-block']) !!}-->
                  </div>
				  </div><br><br>
				  <div> </div>
                  {!! Form::close() !!}
