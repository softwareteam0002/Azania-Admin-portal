...
<div class="sl-mainpanel">
      <nav class="breadcrumb sl-breadcrumb">
        ...
        <a class="breadcrumb-item" href="{{url('frauds')}}">Frauds</a>
        ...
        <div class="row">
          <div class="col-12 col-sm-10 col-md-12">
            <div class="card card-primary">
              ...
              <a href="{{url('frauds')}}" class="btn btn-sm btn-primary">View Frauds</a></div>
              <div class="card-body">
                @if (session('success'))
            ...
            'role' => 'form'
                  ...
                  <div class="row">
                    ...
                    {!! Form::text('fspId',null,['class'=>'form-control', 'placeholder'=>'FSP ID', 'readonly']) !!}
                    </div>
                  </div>
				 <div class="row">
					 <div class="form-group col-6">
