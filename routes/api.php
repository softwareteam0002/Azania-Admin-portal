...
Route::post('agent/pin/change', 'Admin\HomeController@agentPinChange')->middleware('auth:operator');
Route::post('operator/pin/change', 'Admin\HomeController@operatorPinChange')->middleware('auth:operator');
Route::get('agent/pin', 'Admin\HomeController@agentPin')->middleware('auth:operator');
Route::get('operator/pin', 'Admin\HomeController@operatorPin')->middleware('auth:operator');
//Route::post('splash', 'Admin\HomeController@splash');
